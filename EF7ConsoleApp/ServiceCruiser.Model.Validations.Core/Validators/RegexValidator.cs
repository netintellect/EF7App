...
namespace ServiceCruiser.Model.Validations.Core.Validators
{
    public class RegexValidator : ValueValidator<string>
    {
            ...
            ValidationResults validationResults)
        {
            ...
            {
                string x = GetPattern();
                Regex regex = new Regex(x, _options);
        ...
        public string GetPattern()
        {
            ...
            {
                return ResourceStringLoader.LoadString(_patternResourceType.FullName, _patternResourceName, _patternResourceType.Assembly);
            }
        }
        ...
        {
            get { return Translations.RegexValidatorNonNegatedDefaultMessageTemplate; }
        }
        ...
        {
            get { return Translations.RegexValidatorNegatedDefaultMessageTemplate; }
        }
