...
namespace ServiceCruiser.Model.Validations.Core.Validators
{
    ...
    {
        private readonly RangeChecker<int> _rangeChecker;
        ...
        {
            _rangeChecker = new RangeChecker<int>(lowerBound, lowerBoundType, upperBound, upperBoundType);
        }
            ...
            ValidationResults validationResults)
        {
            ...
            {
                if (_rangeChecker.IsInRange(objectToValidate.Length) == Negated)
                {
        ...
        {
            get { return Translations.StringLengthValidatorNonNegatedDefaultMessageTemplate; }
        }
        ...
        {
            get { return Translations.StringLengthValidatorNegatedDefaultMessageTemplate; }
        }
