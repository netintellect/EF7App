...
namespace ServiceCruiser.Model.Validations.Core.Common
{
    /// <summary>
    ...
    {
        private readonly List<ReplacementToken> _tokens = new List<ReplacementToken>();
        ...
        public string Format(string template)
        {
            ...
            // Escape the \{ sequence
            templateBuilder.Replace(@"\{", @"\{.");
            foreach(ReplacementToken token in _tokens)
            {
