...
namespace ServiceCruiser.Model.Entities.Core
{
    public abstract class ValidatedEntity<TEntity> : AuditEntity, IValidate, INotifyDataErrorInfo  where TEntity : BaseEntity
    {
        ...
        public bool HasGraphValidationErrors()
        {
            ...
            var hasErrors = HaveNestedEntitiesValidationErrors(entity => entity.HasGraphValidationErrors());
        ...
        public virtual void Invalidate()
        {
            ...
            foreach (var result in results)
            {
                ...
                if (validateEntity == null) continue;
        ...
        public bool HasGraphErrors
        {
            get { return HasGraphValidationErrors(); }
        }
