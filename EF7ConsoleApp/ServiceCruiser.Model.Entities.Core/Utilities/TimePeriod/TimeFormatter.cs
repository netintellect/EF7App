	...
	public class TimeFormatter : ITimeFormatter
	{
		...
		public virtual string GetDuration( int years, int months, int days, int hours, int minutes, int seconds )
		{
			...
			if ( years != 0 )
			{
				...
				sb.Append( years == 1 ? TimePeriod.Strings.TimeSpanYear : TimePeriod.Strings.TimeSpanYears );
			}
			...
			if ( months != 0 )
			{
				...
				sb.Append( months );
				sb.Append( DurationValueSeparator );
				sb.Append( months == 1 ? TimePeriod.Strings.TimeSpanMonth : TimePeriod.Strings.TimeSpanMonths );
			}
			...
			if ( days != 0 )
			{
				...
				sb.Append( days );
				sb.Append( DurationValueSeparator );
				sb.Append( days == 1 ? TimePeriod.Strings.TimeSpanDay : TimePeriod.Strings.TimeSpanDays );
			}
			...
			if ( hours != 0 )
			{
				...
				sb.Append( hours );
				sb.Append( DurationValueSeparator );
				sb.Append( hours == 1 ? TimePeriod.Strings.TimeSpanHour : TimePeriod.Strings.TimeSpanHours );
			}
			...
			if ( minutes != 0 )
			{
				...
				sb.Append( minutes );
				sb.Append( DurationValueSeparator );
				sb.Append( minutes == 1 ? TimePeriod.Strings.TimeSpanMinute : TimePeriod.Strings.TimeSpanMinutes );
			}
			...
			if ( seconds != 0 )
			{
				...
				sb.Append( seconds );
				sb.Append( DurationValueSeparator );
				sb.Append( seconds == 1 ? TimePeriod.Strings.TimeSpanSecond : TimePeriod.Strings.TimeSpanSeconds );
			}
