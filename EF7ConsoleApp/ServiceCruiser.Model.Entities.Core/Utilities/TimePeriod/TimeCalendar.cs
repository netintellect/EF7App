...
namespace ServiceCruiser.Model.Entities.Core.Utilities.TimePeriod
{
	...
	public class TimeCalendar : ITimeCalendar
	{
		...
		public virtual string GetYearName( int year )
		{
			switch ( YearType )
			{
				case YearType.CalendarYear:
					return TimePeriod.Strings.CalendarYearName( year );
				case YearType.FiscalYear:
					return TimePeriod.Strings.FiscalYearName( year );
				case YearType.SchoolYear:
					return TimePeriod.Strings.SchoolYearName( year );
				default:
					return TimePeriod.Strings.SystemYearName( year );
			}
		} // GetYearName
		...
		public virtual string GetHalfyearName( YearHalfyear yearHalfyear )
		{
			...
			{
				case YearType.CalendarYear:
					return TimePeriod.Strings.CalendarHalfyearName( yearHalfyear );
				case YearType.FiscalYear:
					return TimePeriod.Strings.FiscalHalfyearName( yearHalfyear );
				case YearType.SchoolYear:
					return TimePeriod.Strings.SchoolHalfyearName( yearHalfyear );
				default:
					return TimePeriod.Strings.SystemHalfyearName( yearHalfyear );
			}
		} // GetHalfyearName
		...
		public virtual string GetHalfyearOfYearName( int year, YearHalfyear yearHalfyear )
		{
			...
			{
				case YearType.CalendarYear:
					return TimePeriod.Strings.CalendarHalfyearOfYearName( yearHalfyear, year );
				case YearType.FiscalYear:
					return TimePeriod.Strings.FiscalHalfyearOfYearName( yearHalfyear, year );
				case YearType.SchoolYear:
					return TimePeriod.Strings.SchoolHalfyearOfYearName( yearHalfyear, year );
				default:
					return TimePeriod.Strings.SystemHalfyearOfYearName( yearHalfyear, year );
			}
		...
		public virtual string GetQuarterName( YearQuarter yearQuarter )
		{
			...
			{
				case YearType.CalendarYear:
					return TimePeriod.Strings.CalendarQuarterName( yearQuarter );
				case YearType.FiscalYear:
					return TimePeriod.Strings.FiscalQuarterName( yearQuarter );
				case YearType.SchoolYear:
					return TimePeriod.Strings.SchoolQuarterName( yearQuarter );
				default:
					return TimePeriod.Strings.SystemQuarterName( yearQuarter );
			}
		} // GetQuarterName
		...
		public virtual string GetQuarterOfYearName( int year, YearQuarter yearQuarter )
		{
			...
			{
				case YearType.CalendarYear:
					return TimePeriod.Strings.CalendarQuarterOfYearName( yearQuarter, year );
				case YearType.FiscalYear:
					return TimePeriod.Strings.FiscalQuarterOfYearName( yearQuarter, year );
				case YearType.SchoolYear:
					return TimePeriod.Strings.SchoolQuarterOfYearName( yearQuarter, year );
				default:
					return TimePeriod.Strings.SystemQuarterOfYearName( yearQuarter, year );
			}
		...
		{
			return TimePeriod.Strings.MonthOfYearName( GetMonthName( month ), GetYearName( year ) );
		} // GetMonthOfYearName

		// ----------------------------------------------------------------------
		public virtual string GetWeekOfYearName( int year, int weekOfYear )
		{
			return TimePeriod.Strings.WeekOfYearName( weekOfYear, GetYearName( year ) );
		} // GetWeekOfYearName
